...
public class PythonPattern5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_pattern5);

        ActionBar actionBar = getSupportActionBar();
        assert actionBar != null;
        actionBar.setTitle("Python pattern 5");
        actionBar.setDisplayHomeAsUpEnabled(true);


        program_name = "Pattern 5";
        ...
        int[][] array_string_color = {{86,89},{94,98},{132,135},{140,144}};
        int[][] array_keyword_color_1 = {{0,3},{6,8},{26,29},{32,34},{59,61},{108,112}};
        int[][] array_keyword_color_2 = {{9,14},{35,40},{80,85},{126,131},{150,155}};
        int[][] array_self_color = {};
        int[][] array_end_color = {{90,93},{136,139}};
