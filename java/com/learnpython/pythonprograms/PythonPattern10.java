...
public class PythonPattern10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_pattern10);

        ActionBar actionBar = getSupportActionBar();
        assert actionBar != null;
        actionBar.setTitle("Python pattern 10");
        actionBar.setDisplayHomeAsUpEnabled(true);


        program_name = "Pattern 10";
        ...
        int[][] array_string_color = {{68,72}};
        int[][] array_keyword_color_1 = {{0,3},{6,8},{24,27},{30,32}};
        int[][] array_keyword_color_2 = {{9,14},{33,38},{54,59},{78,83}};
        int[][] array_self_color = {};
        int[][] array_end_color = {{64,67}};
        int[][] array_number_color = {{15,17},{39,41},{62,63}};
