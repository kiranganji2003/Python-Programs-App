...
public class PythonModulesExample1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_modules_example1);
        ...
        actionBar.setTitle("Python modules example 1");
        ...
        example3 = "import Module1\n" +
                "import Module2\n" +
                "\n" +
                "print(\"Calling functions with module name\")\n" +
                "Module1.function1()\n" +
                "Module2.function2()";

        array_string_color = new int[][]{{37,73}};
        array_keyword_color_1 = new int[][]{{0,6},{15,21}};
        ...
        output = "Calling functions with module name\n" +
