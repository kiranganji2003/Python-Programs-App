...
public class PythonGreaterThanOperatorOverloading extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_greater_than_operator_overloading);
        ...
        actionBar.setTitle("Python greater than operator overloading");
        ...
        example1 = "class Student:\n" +
                ...
                "\n" +
                "if std1>std2:\n" +
                "    print(\"Student 1 marks are greater than Student 2\")\n" +
                "else:\n" +
                "    print(\"Student 2 marks are greater than Student 1\")    ";

        array_string_color = new int[][]{{381,425},{443,487}};
        array_keyword_color_1 = new int[][]{{0,5},{19,22},{115,118},{228,230},{254,265},{274,278},{292,304},{357,359},{427,431}};
        array_keyword_color_2 = new int[][]{{375,380},{437,442}};
        ...
        output1 = "Student 2 marks are greater than Student 1";
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.share){
            ...
            intent.putExtra(Intent.EXTRA_SUBJECT,"Python greater than operator overloading");
            String shareMessage = "Python greater than operator overloading" +
                    "\n\n\nExample 1:\n\n" + example1 +
                    "\n\nOutput :-\n\n" + output1 +
