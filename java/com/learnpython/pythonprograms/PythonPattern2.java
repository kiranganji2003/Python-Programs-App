...
public class PythonPattern2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_pattern2);

        ActionBar actionBar = getSupportActionBar();
        assert actionBar != null;
        actionBar.setTitle("Python pattern 2");
        actionBar.setDisplayHomeAsUpEnabled(true);


        program_name = "Pattern 2";
        ...
        int[][] array_string_color = {{60,63},{68,72}};
