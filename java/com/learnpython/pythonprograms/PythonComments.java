...
public class PythonComments extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Python comments");
        actionBar.setDisplayHomeAsUpEnabled(true);

        example1 = "#This is comment. This is also called single-line comment\n" +
                "print(\"Python Programming\")";

        array_string_color = new int[][]{{64,84}};
        array_keyword_color_1 = new int[][]{};
        array_keyword_color_2 = new int[][]{{58,63}};
        array_self_color = new int[][]{};
        array_end_color = new int[][]{};
        array_number_color = new int[][]{};
        array_function_name_color = new int[][]{};
        array_comments = new int[][]{{0,57}};
        ...
        output1 = "Python Programming";
        TextView t_out1 = findViewById(R.id.output1);
        t_out1.setText(output1);

        example2 = "print(\"Hello World\")\t\t#comment can placed at the end of line";

        array_string_color = new int[][]{{6,19}};
        array_keyword_color_1 = new int[][]{};
        ...
        example3 = "'''  This is multi-line comment.\n" +
                "Comments can be used to explain python code, make code more readable\n" +
                "and to prevent execution when testing code.  '''\n" +
                "\n" +
                "print(\"Python is easy to learn\")";

        array_string_color = new int[][]{{158,183}};
        array_keyword_color_1 = new int[][]{};
        array_keyword_color_2 = new int[][]{{152,157}};
        array_self_color = new int[][]{};
        array_end_color = new int[][]{};
        array_number_color = new int[][]{};
        array_function_name_color = new int[][]{};
        array_comments = new int[][]{{0,150}};
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.share){
            ...
            intent.putExtra(Intent.EXTRA_SUBJECT,"Python comments");
            String shareMessage = "Python comments" +
                    "\n\n\nExample 1:\n\n" + example1 +
                    "\n\nOutput :-\n\n" + output1 +
                    "\n\n\nExample 2:\n\n" + example2 +
                    "\n\nOutput :-\n\n" + output2 +
