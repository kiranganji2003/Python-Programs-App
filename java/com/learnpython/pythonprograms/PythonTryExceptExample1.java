...
public class PythonTryExceptExample1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_try_except_example1);
        ...
        actionBar.setTitle("Python try except");
        ...
        array_string_color = new int[][]{{53,76}};
        array_keyword_color_1 = new int[][]{{0,3},{35,41}};
        array_keyword_color_2 = new int[][]{{24,29},{47,52}};
        ...
        example2 = "try:\n" +
                ...
                "except:\n" +
                "    print(\"Cannot accept string\")";

        array_string_color = new int[][]{{24,46},{59,72},{95,117}};
        array_keyword_color_1 = new int[][]{{0,3},{77,83}};
        array_keyword_color_2 = new int[][]{{14,17},{18,23},{53,58},{89,94}};
        array_self_color = new int[][]{};
        array_end_color = new int[][]{};
        ...
        output2 = "Enter the number :- hfg\n" +
                "Cannot accept string";
        ...
        array_string_color = new int[][]{{21,31},{32,35},{91,111}};
        array_keyword_color_1 = new int[][]{{0,3},{41,44},{47,49},{73,79}};
        array_keyword_color_2 = new int[][]{{16,20},{64,69},{85,90}};
        array_self_color = new int[][]{};
        array_end_color = new int[][]{};
        array_number_color = new int[][]{};
        array_function_name_color = new int[][]{};
        ...
        array_string_color = new int[][]{{38,62},{80,86}};
        array_keyword_color_1 = new int[][]{{0,3},{20,26}};
        array_keyword_color_2 = new int[][]{{9,14},{32,37},{74,79}};
        array_self_color = new int[][]{};
        array_end_color = new int[][]{};
        array_number_color = new int[][]{{71,73}};
        array_function_name_color = new int[][]{};
        array_comments = new int[][]{};
        ...
        output4 = "variable doesn't exist\n" +
                "var: 23";
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.share){
            ...
            intent.putExtra(Intent.EXTRA_SUBJECT,"Python try except");
            String shareMessage = "Python try except" +
                    "\n\n\nExample 1:\n\n" + example1 +
                    "\n\nOutput :-\n\n" + output1 +
                    "\n\n\nExample 2:\n\n" + example2 +
                    "\n\nOutput :-\n\n" + output2 +
